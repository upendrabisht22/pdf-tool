...
export const ERROR_DEFINITIONS: Record<ErrorCode, Omit<ErrorDetails, 'code'>> = {
  INVALID_INPUT: {
...
export class PlatformError extends Error {
  ...
  constructor(code: ErrorCode, options?: { message?: string; userAction?: string; jobId?: string; details?: Record<string, unknown> }) {
