...
export function getToolCategory(key) {
  ...
  if (['watermark-pdf', 'page-numbers-pdf', 'strip-metadata-pdf', 'sign-pdf', 'draw-signature', 'flatten-pdf', 'repair-pdf', 'protect-pdf', 'unlock-pdf', 'redact-pdf', 'edit-pdf', 'pdf-editor'].includes(key)) return { name: 'Security & Sign', link: '/edit-pdf' };
